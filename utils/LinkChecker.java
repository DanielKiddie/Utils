...
/**
 * Adapted Udemy link checker, deployed in a given web page, it will check all available links on the page to verify that they function (does not account for JS buttons).
 * 
